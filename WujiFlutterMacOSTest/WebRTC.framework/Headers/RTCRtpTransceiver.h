 ...
 */
RTC_OBJC_EXPORT
__attribute__((objc_runtime_name("WUJI_RTCRtpTransceiverInit"))) @interface RTCRtpTransceiverInit : NSObject
...
RTC_OBJC_EXPORT
__attribute__((objc_runtime_name("WUJI_RTCRtpTransceiver"))) @interface RTCRtpTransceiver : NSObject <RTCRtpTransceiver>
