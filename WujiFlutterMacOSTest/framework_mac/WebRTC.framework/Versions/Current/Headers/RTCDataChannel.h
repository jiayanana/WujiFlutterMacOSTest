...
RTC_OBJC_EXPORT
__attribute__((objc_runtime_name("WUJI_RTCDataBuffer"))) @interface RTCDataBuffer : NSObject
...
RTC_OBJC_EXPORT
__attribute__((objc_runtime_name("WUJI_RTCDataChannel"))) @interface RTCDataChannel : NSObject
